...
axios
     .get('https://jsonplaceholder.typicode.com/todos?_limit=5',{timeout:5000})//timeout gives the time limit for this operation to happen
     .then(res=>showOutput(res))
     .catch(err=>console.log(err));
  ...
  function errorHandling() {
    axios
     ...
     .catch(err=>{
        if(err.response)
        {  //server respondedd with a server other than 200 range
